import { DeviceActions, DeviceConnectionStatus, DeviceEvent, DeviceEvents, IAction } from "../base";
...
export class SwitchableDevice implements ISwitchableDevice  {
    ...
    addEvent(even: DeviceEvent): Event {
        const newEvent=new Event(even.event.name);
